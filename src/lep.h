...
#ifndef LEP_UNIQ_CODE
#define LEP_UNIQ_CODE __COUNTER__
#endif
...
enum Lep_Code
{
	LEP_ERROR_SPI = -LEP_UNIQ_CODE,
	LEP_ERROR_I2C = -LEP_UNIQ_CODE,
	LEP_INFO1 = LEP_UNIQ_CODE
};
...
#define LEP_STATUS_BOOTMODE 0x0002
#define LEP_STATUS_BOOTSTATUS 0x0004
#define LEP_STATUS_OK (LEP_STATUS_BOOTMODE | LEP_STATUS_BOOTSTATUS)
#define LEP_ERROR_MASK 0xFF00
#define LEP_RESERVED_MASK 0x00F8
